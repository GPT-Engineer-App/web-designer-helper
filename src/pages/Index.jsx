  ...
  return (
    <Container centerContent maxW="container.md" height="100vh" display="flex" flexDirection="column" justifyContent="center" alignItems="center">
      <VStack spacing={4}>
        ...
        <Button as={Link} to="/merchandise" colorScheme="brand.900" size="lg">Shop Merchandise</Button>
        <Button as={Link} to="/contact" colorScheme="brand.900" size="lg">Contact Us</Button>
      </VStack>
